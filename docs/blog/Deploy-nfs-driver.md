...
2. 配置参数
   ...
   ![image-20180424222751831](/image-20180424222751831.png)
...
![image-20180424223215278](/image-20180424223215278.png)

## 三、配置应用自动创建容器卷

1. 创建空应用栈并添加服务![image-20180424223735270](/image-20180424223735270.png)

   ![image-20180424223901468](/image-20180424223901468.png)
...
2. 服务创建完成
   ...
   ![image-20180424224424973](/image-20180424224424973.png)

3. UI查看卷状态

   ![image-20180424224544831](/image-20180424224544831.png)

   ![image-20180424233925374](/image-20180424233925374.png)
...
5. 卷API查看
   ...
   ![image-20180424232059217](/image-20180424232059217.png)
...
1. 在存储界面点击 添加卷；
   ...
   ![image-20180424232505159](/image-20180424232505159.png)

   ![image-20180424232543024](/image-20180424232543024.png)

2. 添加卷名，点击创建；

   ![image-20180424232746344](/image-20180424232746344.png)

3. 查看卷状态![image-20180424232857899](/image-20180424232857899.png)

4. 创建服务挂载卷![image-20180424233344875](/image-20180424233344875.png)

5. 从上面的步骤可以发现，挂载手动创建的卷，不需要填写卷驱动名。因为在指定的驱动分类下创建的卷，已经默认了卷驱动，比如我们创建test-3，通过API查看它的驱动信息：

   ![image-20180424234242329](/image-20180424234242329.png)![image-20180424234253198](/image-20180424234253198.png)

   ![image-20180424234324633](/image-20180424234324633.png)
   ...
   2. 在UI界面手动创建卷的形式；
      ...
      ![image-20180425010907187](/image-20180425010907187.png)
